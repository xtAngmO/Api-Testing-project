...
calCart2_response = requests.get(calCartAPI + '?username=DontHaveCartUser')
...
demoAccount = { "username": "demoPayment",
                "password": "correct1", 
                "confirm_password" : "correct1",
                'email' : "correct@email.com", 
                'first_name': "fname", 
...
registerAPI = serverURL + '/register'
createDemoPaymentAccount = requests.post(registerAPI, json=demoAccount)
